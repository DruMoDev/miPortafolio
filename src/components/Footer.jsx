          ...
          <li>
            <a href="https://www.instagram.com/drumulberry" target="_blank">
              <svg
                ...
                fill="currentColor"
                className="xl:w-7 w-4 h-full text-white hover:text-primary transition-all">
          ...
          <li>
            <a href="https://github.com/DruMoDev" target="_blank">
              <svg
                ...
                strokeWidth={2}
                viewBox="0 0 24 24"
                className="xl:w-6 w-3.5 text-white hover:text-primary transition-all">
          ...
          <li>
            <a href="https://www.linkedin.com/in/roger-morera/" target="_blank">
              <svg
                viewBox="0 0 16 16"
                fill="currentColor"
                className="xl:w-7 w-4 text-white hover:text-primary transition-all pb-1">
                <path
                  fill="currentColor"
