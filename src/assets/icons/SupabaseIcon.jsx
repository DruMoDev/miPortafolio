    ...
    <g fill="none">
      ...
      <g clipPath="url(#skillIconsSupabaseDark2)">
        <path
          ...
          d="M144.757 223.193c-5.061 6.373-15.323 2.881-15.445-5.257l-1.783-119.029h80.035c14.496 0 22.581 16.744 13.567 28.097l-76.374 96.189Z"></path>
        <path
        ...
        <path
          fill="#fff"
          d="M112.207 31.666c5.061-6.375 15.323-2.882 15.445 5.256l.782 119.029H49.4c-14.497 0-22.582-16.744-13.567-28.097l76.374-96.189Z"></path>
      </g>
      <defs>
        <linearGradient
