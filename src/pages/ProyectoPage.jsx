    ...
    <>
      <main className="container mx-auto pt-20 min-h-screen flex flex-col items-center lg:hidden">
        ...
        <div className="flex items-center justify-between w-full">
          <Link
            className=" bg-quinary border-primary border  text-primary   py-2 px-4 rounded-lg font-bold hover:bg-primary hover:text-white hover:border-white transition duration-300"
            to={url}
            target="_blank"
